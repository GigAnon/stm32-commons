...
bool RegionEU868TxConfig( TxConfigParams_t* txConfig, int8_t* txPower, TimerTime_t* txTimeOnAir )
{
    ...
    {
        modem = MODEM_LORA;
        /* PATCH: changed the TX timeout value from 3s to 6s */
        Radio.SetTxConfig( modem, phyTxPower, 0, bandwidth, phyDr, 1, 8, false, true, 0, 0, false, /*3000*/6000 );
    }
